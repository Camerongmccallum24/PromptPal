    ...
    <div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden mb-6">
        <div className="p-4 border-b border-gray-200 bg-gray-50 flex flex-wrap gap-4">
          ...
          >
            {showFavoritesOnly ? <Star size={16} className="mr-2" /> : <StarOff size={16} className="mr-2" />}
      ...
      <div className="flex justify-between items-start">
        <div className="flex-1">
          <div className="flex items-center mb-1">
            ...
            >
              {prompt.updatedAt > prompt.createdAt ? 'Optimized' : 'Draft'}
            </span>
            <button
              onClick={(e) => {
                e.stopPropagation();
              ...
              <div className="flex items-center space-x-1">
                ...
                <div className="flex flex-wrap gap-1">
                  {prompt.tags.map(tagId => (
                    <span key={tagId} className="text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full flex items-center">
